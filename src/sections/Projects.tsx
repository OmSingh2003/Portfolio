...
const Projects = () => {
  ...
  const allProjects = [
    ...
    },
    {
      ...
      description: 'A mobile application for organizing tasks, setting deadlines, and tracking progress.',
    ...
    },
    {
      ...
      description: 'Interactive dashboard for tracking personal finances, expenses, and investments.',
    ...
    },
    {
      ...
      description: 'UI/UX redesign project for a restaurant chain to improve user experience and conversion.',
